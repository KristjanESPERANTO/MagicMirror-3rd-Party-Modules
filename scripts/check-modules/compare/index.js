...
const PIPELINE_ARTIFACTS = [
  {
    id: "modules.stage.4.json",
    paths: [
      "fixtures/data/modules.stage.4.json",
...
function createInitialPlan({ fixturesPath, legacyCommand, tsCommand, runId, runDirectory }) {
  return {
    ...
    runs: [],
    notes: [
      "Harness captures outputs for the configured runs and diffs their Stage 4 artifacts when more than one command executes.",
...
async function writePlanReadme(directory) {
  ...
  const readmeContents = [
    ...
    "captures stdout/stderr alongside selected Stage 4 artifacts for each",
...
async function runCli() {
  ...
  program
    ...
    .description("Compare outputs between Stage 4 runs using the curated fixtures (diff harness).")
