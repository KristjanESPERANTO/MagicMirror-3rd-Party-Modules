  ...
  for (const file of changedFiles) {
    ...
    try {
      ...
      if (results.accessible) {
        ...
        results.hasLicense = await checkFileExists(submission.url, "LICENSE") ||
          await checkFileExists(submission.url, "LICENSE.md") ||
          await checkFileExists(submission.url, "LICENSE.txt");
        results.hasReadme = await checkFileExists(submission.url, "README.md") ||
          await checkFileExists(submission.url, "readme.md");
      }
