...
2. Typo: Found 'Magic Mirror' in file `MMM-Birthdays.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `BIRTHDAYS.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `COINSQUARE.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `DWD-RealtimeIrishRail.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'XMLHttpRequest' in file `DWD-RealtimeIrishRail.js`: Replace it with built-in fetch.
...
1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `emt.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-1-Second-A-Day.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-2Day-NOAA-Forecast.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-AC-aseag.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-AOE2-STATS.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Api.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'MagicMirror2' in file `installer.sh`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-APOD.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-APOD.js`: Replace it with built-in fetch.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-AareGuru.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-AfterShip.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-AfterShip.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-AfterShip.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-AirbarHelper.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `alexaRunner.babel.js`: Replace it with built-in fetch.
2. Recommendation: Found 'XMLHttpRequest' in file `runDirectives.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-AlexaOnOff.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-AllsvenskanStandings by retroflex](https://github.com/retroflex/MMM-AllsvenskanStandings)

1. Typo: Found 'Magic Mirror' in file `MMM-AllsvenskanStandings.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
4. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Deprecated: Found 'require("request")' in file `aoc.js`: Replace it with built-in fetch.

## [MMM-ApexLegends by retroflex](https://github.com/retroflex/MMM-ApexLegends)

1. Typo: Found 'Magic Mirror' in file `MMM-ApexLegends.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Astrology.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Astronauts.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require('request')' in file `atb.js`: Replace it with built-in fetch.
...
1. Deprecated: Found 'require("native-request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Avinor.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `readme.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-BCFerries.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-BMI.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-BMW by mykle1](https://github.com/mykle1/MMM-BMW)

1. Typo: Found 'Magic Mirror' in file `MMM-wundergroundBar.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-BMW-CC by mykle1](https://github.com/mykle1/MMM-BMW-CC)

1. Typo: Found 'Magic Mirror' in file `MMM-BMW-CC.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-BMW-DS by mykle1](https://github.com/mykle1/MMM-BMW-DS)

1. Typo: Found 'Magic Mirror' in file `MMM-BMW-DS.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-BMW-OW by mykle1](https://github.com/mykle1/MMM-BMW-OW)

1. Typo: Found 'Magic Mirror' in file `MMM-BMW-OW.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'require("https")' in file `bmwrequest.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-BackgroundSlideshow by darickc](https://github.com/darickc/MMM-BackgroundSlideshow)

1. Typo: Found 'Magic Mirror' in file `MMM-BackgroundSlideshow.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'omxplayer' in file `node_helper.js`: Try to replace it with `vlc`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-BinaryClock.js`: Replace it with `MagicMirror²`.

## [MMM-Bixi by nictruong](https://github.com/nictruong/MMM-Bixi)

1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'node-fetch' in file `BIXIFetcher.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Block.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Bluelinky.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `BoredDaily.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Bose-Soundtouch.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-BrawlStars by retroflex](https://github.com/retroflex/MMM-BrawlStars)

1. Typo: Found 'Magic Mirror' in file `MMM-BrawlStars.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-Brewdog by jsteel715](https://github.com/jsteel715/MMM-Brewdog)

1. Typo: Found 'Magic Mirror' in file `MMM-Brewdog.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Deprecated: Found 'require("request")' in file `bring-profile.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Bubi by balassy](https://github.com/balassy/MMM-Bubi)

1. Typo: Found 'Magic Mirror' in file `MMM-Bubi.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-Bubi.js`: Replace it with built-in fetch.

## [MMM-Buienradar by StefanNienhuis](https://github.com/StefanNienhuis/MMM-Buienradar)

1. Typo: Found 'Magic Mirror' in file `MMM-Buienradar.js`: Replace it with `MagicMirror²`.

## [MMM-Buller by da4throux](https://github.com/da4throux/MMM-Buller)

1. Typo: Found 'Magic Mirror' in file `MMM-Buller.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Button by ptrbld](https://github.com/ptrbld/MMM-Button)

1. Typo: Found 'Magic Mirror' in file `MMM-Button.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Buttons.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-CARDS by mykle1](https://github.com/mykle1/MMM-CARDS)

1. Typo: Found 'Magic Mirror' in file `MMM-CARDS.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
2. Recommendation: Found 'node-fetch' in file `calendarfetcher.js`: Replace it with built-in fetch.

## [MMM-CalendarWeek by heskja](https://github.com/heskja/MMM-CalendarWeek)

1. Typo: Found 'Magic Mirror' in file `MMM-CalendarWeek.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Callmonitor-Current-Call.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Caltrain.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Canvas.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Census by mykle1](https://github.com/mykle1/MMM-Census)

1. Typo: Found 'Magic Mirror' in file `MMM-Census.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Chart by MarinescuEvghenii](https://github.com/MarinescuEvghenii/MMM-Chart)

1. Typo: Found 'Magic Mirror' in file `MMM-Chart.js`: Replace it with `MagicMirror²`.

## [MMM-Chess-Daily by nout-kleef](https://github.com/nout-kleef/MMM-Chess-Daily)

1. Typo: Found 'Magic Mirror' in file `MMM-Chess-Daily.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Chuck-Norris by toddsantoro](https://github.com/toddsantoro/MMM-Chuck-Norris)

1. Typo: Found 'Magic Mirror' in file `MMM-Chuck-Norris.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-Chuck-Norris.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
5. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Clash-Royale.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Climacell-Hourly.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Clockinese by mykle1](https://github.com/mykle1/MMM-Clockinese)

1. Typo: Found 'Magic Mirror' in file `MMM-Clockinese.js`: Replace it with `MagicMirror²`.

## [MMM-CloneWarsQuotes by macd2point0](https://github.com/macd2point0/MMM-CloneWarsQuotes)

1. Typo: Found 'Magic Mirror' in file `MMM-CloneWarsQuotes.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-CloneWarsQuotes.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Cocktails.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-CollegeFootballTop25.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-CommandToNotification.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-ConcertsCalendar by muilpp](https://github.com/muilpp/MM-concert-calendar)

1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `concertcalendar.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'XMLHttpRequest' in file `concertcalendar.js`: Replace it with built-in fetch.

## [MMM-CountUP by bibaldo](https://github.com/bibaldo/MMM-CountUP)

1. Typo: Found 'Magic Mirror' in file `MMM-CountUP.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Covid19-Vaccination.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-CracowMPK by wkra](https://github.com/wkra/MMM-CracowMPK)

1. Typo: Found 'Magic Mirror' in file `MMM-CracowMPK.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Cronixie.js`: Replace it with `MagicMirror²`.

## [MMM-CuandoLlega by bibaldo](https://github.com/bibaldo/MMM-CuandoLlega)

1. Typo: Found 'Magic Mirror' in file `MMM-CuandoLlega.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Currentweather-MQTT.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-Currentweather-MQTT.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-CyberSecurityNews.js`: Replace it with `MagicMirror²`.

## [MMM-CzechPost by RichieCZ](https://github.com/RichieCZ/MMM-CzechPost)

1. Recommendation: Found 'XMLHttpRequest' in file `MMM-CzechPost.js`: Replace it with built-in fetch.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-DBF.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-DBF.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-DCMetroTimes by kyle-kelly](https://github.com/kyle-kelly/MMM-DCMetroTimes)

1. Typo: Found 'Magic Mirror' in file `MMM-DCMetroTimes.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'require('https')' in file `node_helper.js`: Replace it with built-in fetch.
5. Recommendation: Found 'require('https')' in file `getStationCodes.js`: Replace it with built-in fetch.

## [MMM-DCMetroTrainTimes by AdamMoses-GitHub](https://github.com/AdamMoses-GitHub/MMM-DCMetroTrainTimes)

1. Typo: Found 'Magic Mirror' in file `MMM-DCMetroTrainTimes.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'require('https')' in file `node_helper.js`: Replace it with built-in fetch.
5. Recommendation: Found 'require('https')' in file `getStationCodes.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-DWD-WarnWeather.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.
5. Recommendation: Found 'node-fetch' in file `package.json`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Dad-Jokes.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-DaikinAirbase.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-DailyPokemon.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-DailyPokemon.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `weather.html`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-DarkSkyRadar.js`: Replace it with `MagicMirror²`.

## [MMM-DateCounter by alltopafi](https://github.com/alltopafi/MMM-DateCounter)

1. Typo: Found 'Magic Mirror' in file `MMM-DateCounter.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-DateCounter.js`: Replace it with built-in fetch.

## [MMM-DateOnly by grabenhenrich](https://github.com/grabenhenrich/MMM-DateOnly)

1. Typo: Found 'Magic Mirror' in file `MMM-DateOnly.js`: Replace it with `MagicMirror²`.

## [MMM-DeLijn by wouter-heerwegh](https://github.com/wouter-heerwegh/MMM-DeLijn)

1. Recommendation: Found 'XMLHttpRequest' in file `MMM-DeLijn.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.

## [MMM-DefaultWeatherAnimated by MatthiPi](https://github.com/MatthiPi/MMM-DefaultWeatherAnimated)

1. Typo: Found 'Magic Mirror' in file `weather.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-DockerVisualizer.js`: Replace it with `MagicMirror²`.
...
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
4. Issue: Found directory `node_modules`. This shouldn't be uploaded. Add `node_modules/`to `.gitignore`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-EARTH-Live.js`: Replace it with `MagicMirror²`.

## [MMM-EFA-departures by Dom1n1c](https://github.com/Dom1n1c/MMM-EFA-departures)

1. Typo: Found 'Magic Mirror' in file `MMM-EFA-departures.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-ELMPrayerTime by moinahmed001](https://github.com/moinahmed001/MMM-ELMPrayerTime)

1. Recommendation: Found 'XMLHttpRequest' in file `MMM-ELMPrayerTime.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'omxplayer' in file `node_helper.js`: Try to replace it with `vlc`.

## [MMM-EOL by mykle1](https://github.com/mykle1/MMM-EOL)

1. Typo: Found 'Magic Mirror' in file `MMM-EOL.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Earthquake by mykle1](https://github.com/mykle1/MMM-Earthquake)

1. Typo: Found 'Magic Mirror' in file `MMM-Earthquake.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-EasyPix by mykle1](https://github.com/mykle1/MMM-EasyPix)

1. Typo: Found 'Magic Mirror' in file `MMM-EasyPix.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-EmbedURL.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-EnphaseSolar.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'require('https')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Ethos.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-Ethos.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-EventHorizon by mykle1](https://github.com/mykle1/MMM-EventHorizon)

1. Typo: Found 'Magic Mirror' in file `MMM-EventHorizon.js`: Replace it with `MagicMirror²`.

## [MMM-Events by mykle1](https://github.com/mykle1/MMM-Events)

1. Typo: Found 'Magic Mirror' in file `MMM-Events.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-EveryNews by mykle1](https://github.com/mykle1/MMM-EveryNews)

1. Typo: Found 'Magic Mirror' in file `MMM-EveryNews.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-EyeCandy by mykle1](https://github.com/mykle1/MMM-EyeCandy)

1. Typo: Found 'Magic Mirror' in file `MMM-EyeCandy.js`: Replace it with `MagicMirror²`.

## [MMM-F1 by jupadin](https://github.com/jupadin/MMM-F1)

1. Typo: Found 'Magic Mirror' in file `MMM-F1.css`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-F1.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-FF-Evan-Roth-Red-Lines.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-FF-Evan-Roth-Red-Lines.css`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `MMM-FF-Evan-Roth-Red-Lines.scss`: Replace it with `MagicMirror²`.

## [MMM-FF-Genius-Lyrics by shin10](https://github.com/shin10/MMM-FF-Genius-Lyrics)

1. Typo: Found 'Magic Mirror' in file `MMM-FF-Genius-Lyrics.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `lyricsFetcher.js`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
5. Issue: Found directory `node_modules`. This shouldn't be uploaded. Add `node_modules/`to `.gitignore`.
6. Typo: Found 'Magic Mirror' in file `MMM-FF-Genius-Lyrics.css`: Replace it with `MagicMirror²`.
7. Typo: Found 'Magic Mirror' in file `MMM-FF-Genius-Lyrics.scss`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-FF-XKCD.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `comicFetcher.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'require("https")' in file `comicFetcher.js`: Replace it with built-in fetch.
...
7. Typo: Found 'Magic Mirror' in file `MMM-FF-XKCD.css`: Replace it with `MagicMirror²`.
8. Typo: Found 'Magic Mirror' in file `MMM-FF-XKCD.scss`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-FF-code-injector.js`: Replace it with `MagicMirror²`.

## [MMM-FF-digital-rain by shin10](https://github.com/shin10/MMM-FF-digital-rain)

1. Typo: Found 'Magic Mirror' in file `MMM-FF-digital-rain.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-FF-digital-rain.css`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `MMM-FF-digital-rain.scss`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-FF-process-stats.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `MMM-FF-process-stats.css`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `MMM-FF-process-stats.scss`: Replace it with `MagicMirror²`.

## [MMM-FF-tenor-gif by shin10](https://github.com/shin10/MMM-FF-tenor-gif)

1. Typo: Found 'Magic Mirror' in file `MMM-FF-tenor-gif.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `gifFetcher.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'require("https")' in file `gifFetcher.js`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
5. Typo: Found 'Magic Mirror' in file `MMM-FF-tenor-gif.css`: Replace it with `MagicMirror²`.
6. Typo: Found 'Magic Mirror' in file `MMM-FF-tenor-gif.scss`: Replace it with `MagicMirror²`.

## [MMM-FHEM by BenRoe](https://github.com/BenRoe/MMM-FHEM)

1. Typo: Found 'Magic Mirror' in file `MMM-FHEM.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-FMI.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-FSAPI.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Face-Multi-User-Recognition-SMAI.js`: Replace it with `MagicMirror²`.

## [MMM-Face-Reco-DNN by nischi](https://github.com/nischi/MMM-Face-Reco-DNN)

1. Typo: Found 'Magic Mirror' in file `MMM-Face-Reco-DNN.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Facial-Recognition.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-Facial-Recognition-OCV3 by normyx](https://github.com/normyx/MMM-Facial-Recognition-OCV3)

1. Typo: Found 'Magic Mirror' in file `MMM-Facial-Recognition-OCV3.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-Farevarsel by mabahj](https://github.com/mabahj/MMM-Farevarsel)

1. Typo: Found 'Magic Mirror' in file `MMM-Farevarsel.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Fish.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Flickr.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-FlipClock.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'XMLHttpRequest' in file `flip.js`: Replace it with built-in fetch.

## [MMM-Flo by kagjerde](https://github.com/kagjerde/MMM-Flo)

1. Typo: Found 'Magic Mirror' in file `MMM-Flo.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-FloGraph.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Fortnite.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-FortniteStats by yourdawi](https://github.com/yourdawi/MMM-FortniteStats)

1. Recommendation: Found 'XMLHttpRequest' in file `MMM-FortniteStats.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.

## [MMM-Fortune by mykle1](https://github.com/mykle1/MMM-Fortune)

1. Typo: Found 'Magic Mirror' in file `MMM-Fortune.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-GHIN.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-GPIO-Notifications.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `HC-SR501-GPIO4-README-DE.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'electron-rebuild' in file `postinstall`: Replace it with `@electron/rebuild`

## [MMM-GPSWeather by mochman](https://github.com/mochman/MMM-GPSWeather)

1. Typo: Found 'Magic Mirror' in file `MMM-GPSWeather.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-GPSWeather.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-GeoTracking.js`: Replace it with `MagicMirror²`.
...
1. Deprecated: Found 'require("request")' in file `MergeRequestFetcher.js`: Replace it with built-in fetch.

## [MMM-Glance by tttooommm56](https://github.com/tttooommm56/MMM-Glance)

1. Typo: Found 'Magic Mirror' in file `MMM-Glance.js`: Replace it with `MagicMirror²`.

## [MMM-Globe by LukeSkywalker92](https://github.com/LukeSkywalker92/MMM-Globe)

1. Typo: Found 'Magic Mirror' in file `MMM-Globe.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-GoogleAssistant.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-GoogleMapsTraffic.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-GyeonggiBus.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-HH-LocalTransport.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-HRS-PickupPlan.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-HTMLSnippet by ulrichwisser](https://github.com/ulrichwisser/MMM-HTMLSnippet)

1. Typo: Found 'Magic Mirror' in file `MMM-HTMLSnippet.js`: Replace it with `MagicMirror²`.

## [MMM-HTTPRequestDisplay by Eunanibus](https://github.com/Eunanibus/MMM-HTTPRequestDisplay)

1. Typo: Found 'Magic Mirror' in file `MMM-HTTPRequestDisplay.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-HTTPRequestDisplay.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-HabiticaStats.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `HabiticaMagic-v2.0.1.min.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Helium-Wallet.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-Hello-Mirror by Matzefication](https://github.com/Matzefication/MMM-Hello-Mirror)

1. Typo: Found 'Magic Mirror' in file `MMM-Hello-Mirror.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-Hello-Mirror.css`: Replace it with `MagicMirror²`.

## [MMM-HideAll by Snille](https://github.com/Snille/MMM-HideAll)

1. Typo: Found 'Magic Mirror' in file `MMM-HideAll.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `jquery.js`: Replace it with built-in fetch.

## [MMM-History by cowboysdude](https://github.com/cowboysdude/MMM-History)

1. Typo: Found 'Magic Mirror' in file `MMM-History.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Hive by flick116](https://github.com/flick116/MMM-Hive)

1. Typo: Found 'Magic Mirror' in file `MMM-Hive.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-HomeAutomationNotifications.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Hue.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `jquery.js`: Replace it with built-in fetch.

## [MMM-Hue-Controller by gueguet](https://github.com/gueguet/MMM-Hue-Controller)

1. Typo: Found 'Magic Mirror' in file `MMM-Hue-Controller.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `mmm-hue-lights.js`: Replace it with `MagicMirror²`.

## [MMM-HumanCalendar by mykle1](https://github.com/mykle1/MMM-HumanCalendar)

1. Typo: Found 'Magic Mirror' in file `MMM-HumanCalendar.js`: Replace it with `MagicMirror²`.

## [MMM-HumanClock by mykle1](https://github.com/mykle1/MMM-HumanClock)

1. Typo: Found 'Magic Mirror' in file `MMM-HumanClock.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-IPT.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-ISS-Live.js`: Replace it with `MagicMirror²`.

## [MMM-ISY by shbatm](https://github.com/shbatm/MMM-ISY)

1. Typo: Found 'Magic Mirror' in file `MMM-ISY.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `jquery-3.2.1.min.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-IconDisplayer.js`: Replace it with `MagicMirror²`.
...
3. Typo: Found 'Magic Mirror' in file `etafetcher.js`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-ImageFileWatcher.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-ImageSlideshow.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-IndoorTemp by sebastianhodapp](https://github.com/sebastianhodapp/MMM-IndoorTemp)

1. Typo: Found 'Magic Mirror' in file `MMM-IndoorTemp.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-inspirobot.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.

## [MMM-Instagram by kapsolas](https://github.com/kapsolas/MMM-Instagram)

1. Typo: Found 'Magic Mirror' in file `MMM-Instagram.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Insults.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-IntelligentOctopus by ianmccon](https://github.com/ianmccon/MMM-IntelligentOctopus)

1. Typo: Found 'Magic Mirror' in file `MMM-IntelligentOctopus.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-IntelligentOctopus.js`: Replace it with built-in fetch.

## [MMM-IronManGIF by 2hdlockness](https://github.com/2hdlockness/MMM-IronManGIF)

1. Typo: Found 'Magic Mirror' in file `MMM-IronManGIF.js`: Replace it with `MagicMirror²`.

## [MMM-JEOPARDY-Enhanced by fering3](https://github.com/fering3/MMM-JEOPARDY-Enhanced)

1. Typo: Found 'Magic Mirror' in file `MMM-JEOPARDY-Enhanced.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-JNV.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'require("https")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-Jeedom.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'require('https')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-JewishDate by yohaybn](https://github.com/yohaybn/MMM-JewishDate)

1. Typo: Found 'Magic Mirror' in file `MMM-JewishDate.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-JewishDate.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-JustForTodayMeditation.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-JustForTodayMeditation.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
5. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Kanji-Random.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-LAMetro.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
4. Deprecated: Found 'require('request')' in file `pt_helper.js`: Replace it with built-in fetch.

## [MMM-LCDControl by Txukie](https://github.com/Txukie/MMM-LCDControl)

1. Typo: Found 'Magic Mirror' in file `MMM-LCDControl.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-LEDStripControl by Tom-Hirschberger](https://github.com/Tom-Hirschberger/MMM-LEDStripControl)

1. Typo: Found 'Magic Mirror' in file `MMM-LEDStripControl.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-LICE by mykle1](https://github.com/mykle1/MMM-LICE)

1. Typo: Found 'Magic Mirror' in file `MMM-LICE.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Launch.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-LeagueOfLegends by JulianEgbert](https://github.com/JulianEgbert/MMM-LeagueOfLegends)

1. Typo: Found 'Magic Mirror' in file `MMM-LeagueOfLegends.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-LeagueOfLegends.js`: Replace it with built-in fetch.

## [MMM-LesJoiesDuCode by Tomadelostacos](https://github.com/Tomadelostacos/MMM-LesJoiesDuCode)

1. Typo: Found 'Magic Mirror' in file `MMM-LesJoiesDuCode.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Letterboxd by tristanburke](https://github.com/tristanburke/MMM-Letterboxd)

1. Typo: Found 'Magic Mirror' in file `MMM-Letterboxd.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'node-fetch' in file `fetch_logos.js`: Replace it with built-in fetch.
3. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
5. Recommendation: Found 'node-fetch' in file `package.json`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `custom.md`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-LoadShedding.js`: Replace it with `MagicMirror²`.

## [MMM-LocalEvents by dwoolridge](https://github.com/dwoolridge/MMM-LocalEvents)

1. Recommendation: Found 'XMLHttpRequest' in file `eventprovider.js`: Replace it with built-in fetch.

## [MMM-LocalTemperature by glitch452](https://github.com/glitch452/MMM-LocalTemperature)

1. Typo: Found 'Magic Mirror' in file `MMM-LocalTemperature.css`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-LocalTemperature.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Logging.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Looko2-aq by marska](https://github.com/marska/MMM-Looko2-aq)

1. Typo: Found 'Magic Mirror' in file `MMM-Looko2-aq.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-Looko2-aq.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Lottery.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Loxone by idoodler](https://github.com/idoodler/MMM-Loxone)

1. Recommendation: Found 'XMLHttpRequest' in file `jquery.min.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-MARS.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-MBTA by edward-shen](https://github.com/edward-shen/MMM-MBTA)

1. Recommendation: Found 'XMLHttpRequest' in file `MMM-MBTA.js`: Replace it with built-in fetch.

## [MMM-MD by AndreaGrandieri](https://github.com/AndreaGrandieri/MMM-MD)

1. Recommendation: Found 'XMLHttpRequest' in file `MMM-MD.js`: Replace it with built-in fetch.

## [MMM-MHZ19 by awitwicki](https://github.com/awitwicki/MMM-MHZ19)

1. Typo: Found 'Magic Mirror' in file `MMM-MHZ19.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-MP3Player by asimhsidd](https://github.com/asimhsidd/MMM-MP3Player)

1. Typo: Found 'Magic Mirror' in file `MMM-MP3Player.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `mpd_client.js`: Replace it with `MagicMirror²`.

## [MMM-MPR121 by PatriceG](https://github.com/PatriceG/MMM-MPR121)

1. Typo: Found 'Magic Mirror' in file `MMM-MPR121.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'electron-rebuild' in file `package.json`: Replace it with `@electron/rebuild`
...
1. Typo: Found 'Magic Mirror' in file `MMM-MQTT.css`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-MQTT.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-MQTTfloorplan.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `config.js.sample.js`: Replace it with `MagicMirror²`.

## [MMM-MTA-NextBus by tie624](https://github.com/tie624/MMM-MTA-NextBus)

1. Typo: Found 'Magic Mirror' in file `MMM-MTA-NextBus.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-MataChuan.js`: Replace it with `MagicMirror²`.

## [MMM-Mattermost by O5ten](https://github.com/O5ten/MMM-Mattermost)

1. Typo: Found 'Magic Mirror' in file `MMM-Mattermost.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Memo by schnibel](https://github.com/schnibel/MMM-Memo)

1. Typo: Found 'Magic Mirror' in file `MMM-Memo.css`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-Memo.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-MiBiciTuBici.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Deprecated: Found 'require("request")' in file `mieleathome.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-MirrorMirrorOnTheWall.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `controls.py`: Replace it with `MagicMirror²`.
...
1. Deprecated: Found 'electron-rebuild' in file `package.json`: Replace it with `@electron/rebuild`

## [MMM-Modulebar by Snille](https://github.com/Snille/MMM-Modulebar/)

1. Typo: Found 'Magic Mirror' in file `MMM-Modulebar.css`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-Modulebar.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `MMM-Modulebar.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Mopidy-MPD.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-MovieListings.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Multimonth.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-MySenseHat.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
5. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-MyTTC.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'XMLHttpRequest' in file `node_helper.js`: Replace it with built-in fetch.
4. Issue: Found directory `node_modules`. This shouldn't be uploaded. Add `node_modules/`to `.gitignore`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-MyWordsRandomed.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-NASA.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-NBA by jupadin](https://github.com/jupadin/MMM-NBA)

1. Typo: Found 'Magic Mirror' in file `MMM-NBA.css`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-NBA.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-NEO.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-NameDay.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-NatureCalendar.js`: Replace it with `MagicMirror²`.

## [MMM-NatureRemo by mtatsuma](https://github.com/mtatsuma/MMM-NatureRemo)

1. Typo: Found 'Magic Mirror' in file `MMM-NatureRemo.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.

## [MMM-Navigate by Ax-LED](https://github.com/Ax-LED/MMM-Navigate)

1. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'electron-rebuild' in file `postinstall`: Replace it with `@electron/rebuild`

## [MMM-NearCompliments by semox](https://github.com/semox/MMM-NearCompliments)

1. Typo: Found 'Magic Mirror' in file `MMM-NearCompliments.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `mmm-nest-cameras.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Nest-Status by michael5r](https://github.com/michael5r/mmm-nest-status)

1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `mmm-nest-status.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Netatmo-Thermostat.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `jquery-3.2.1.min.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-News-QR.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `fetcher.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require("request")' in file `fetcher.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-NextCloud-Tasks by starlingfire](https://github.com/starlingfire/MMM-NextCloud-Tasks)

1. Typo: Found 'Magic Mirror' in file `MMM-NextCloud-Tasks.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-NextTrains by CptMeetKat](https://github.com/CptMeetKat/MMM-NextTrains)

1. Typo: Found 'Magic Mirror' in file `NextTrains.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'require('https')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Nixie-Clock-working.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-Nixie-Clock.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-NoteTaker.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `DateFormat.js`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `PropertiesView.js`: Replace it with `MagicMirror²`.
5. Typo: Found 'Magic Mirror' in file `ListView.js`: Replace it with `MagicMirror²`.
6. Typo: Found 'Magic Mirror' in file `ListViewElement.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-NsInfo.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'XMLHttpRequest' in file `stations.js`: Replace it with built-in fetch.

## [MMM-ObjectBlocks by jimmykh](https://github.com/jimmykh/MMM-ObjectBlocks)

1. Typo: Found 'Magic Mirror' in file `MMM-ObjectBlocks.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-OctoMon by christopherpthomas](https://github.com/christopherpthomas/MMM-OctoMon)

1. Typo: Found 'Magic Mirror' in file `MMM-OctoMon.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-OctoMon.js`: Replace it with built-in fetch.

## [MMM-Oelpreise by eckonator](https://github.com/eckonator/MMM-Oelpreise)

1. Typo: Found 'Magic Mirror' in file `MMM-Oelpreise.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `olympia.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-OneTouchReveal.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-OneTracker by seeshaughnessy](https://github.com/seeshaughnessy/MMM-OneTracker)

1. Typo: Found 'Magic Mirror' in file `MMM-OneTracker.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-OpenSprinkler.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
4. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-OpenTherm.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-OpenWeatherMapForecast by MarcLandis](https://github.com/MarcLandis/MMM-OpenWeatherMapForecast)

1. Typo: Found 'Magic Mirror' in file `MMM-OpenWeatherMapForecast.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-OpenmapWeather.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-OpenmapWeather.js`: Replace it with built-in fetch.

## [MMM-OsloCityBike by TobbenTM](https://github.com/TobbenTM/MMM-OsloCityBike)

1. Typo: Found 'Magic Mirror' in file `MMM-OsloCityBike.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-OsloCityBike.js`: Replace it with built-in fetch.

## [MMM-Oura by erchenger](https://github.com/erchenger/MMM-Oura)

1. Typo: Found 'Magic Mirror' in file `MMM-Oura.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Overwatch by retroflex](https://github.com/retroflex/MMM-Overwatch)

1. Typo: Found 'Magic Mirror' in file `MMM-Overwatch.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-PC-Stats by mykle1](https://github.com/mykle1/MMM-PC-Stats)

1. Typo: Found 'Magic Mirror' in file `MMM-PC-Stats.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
9. Recommendation: Found 'XMLHttpRequest' in file `favorites.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-PIR-Sensor.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-PLOW.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Parcel.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'node-fetch' in file `README.md`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
5. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.
...
9. Recommendation: Found 'node-fetch' in file `routes.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-PasadenaTransit.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
4. Deprecated: Found 'require('request')' in file `pt_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-PenPlotter.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-PetFinder.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-PilotWX.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-PimaticFloorplan by marcelwinh](https://github.com/marcelwinh/MMM-PimaticFloorplan)

1. Typo: Found 'Magic Mirror' in file `MMM-PimaticFloorplan.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `ping.js`: Replace it with `MagicMirror²`.

## [MMM-Pins by ptrbld](https://github.com/ptrbld/mmm-pins)

1. Typo: Found 'Magic Mirror' in file `MMM-Pins.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'electron-rebuild' in file `package.json`: Replace it with `@electron/rebuild`
...
1. Typo: Found 'Magic Mirror' in file `MMM-PlaceInfo.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-PlaceInfo.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-PlexNowPlaying.css`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-PlexNowPlaying.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'XMLHttpRequest' in file `MMM-PlexNowPlaying.js`: Replace it with built-in fetch.

## [MMM-PlexSlideshow by PjTewkesbury](https://github.com/PjTewkesbury/MMM-PlexSlideshow)

1. Typo: Found 'Magic Mirror' in file `MMM-PlexSlideshow.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-PlexSlideshow.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Podcast by ptrbld](https://github.com/ptrbld/MMM-Podcast)

1. Deprecated: Found 'omxplayer' in file `README.md`: Try to replace it with `vlc`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'electron-rebuild' in file `package.json`: Replace it with `@electron/rebuild`

## [MMM-Podcast2 by Ax-LED](https://github.com/Ax-LED/MMM-Podcast2)

1. Typo: Found 'Magic Mirror' in file `MMM-Podcast2.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'omxplayer' in file `README.md`: Try to replace it with `vlc`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
5. Deprecated: Found 'omxplayer' in file `node_helper.js`: Try to replace it with `vlc`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-PopulationClock.js`: Replace it with `MagicMirror²`.

## [MMM-PostDelivery-Norway by reidarw](https://github.com/reidarw/MMM-PostDelivery-Norway)

1. Typo: Found 'Magic Mirror' in file `MMM-PostDelivery-Norway.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
4. Recommendation: Found 'XMLHttpRequest' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Powerwall.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.
5. Recommendation: Found 'node-fetch' in file `package.json`: Replace it with built-in fetch.
6. Recommendation: Found 'require("https")' in file `powerwall.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-PreciousMetals.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Pregnancy.js`: Replace it with `MagicMirror²`.

## [MMM-Profile by kurtern84](https://github.com/kurtern84/MMM-profile)

1. Typo: Found 'Magic Mirror' in file `MMM-Profile.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-Profile.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-ProfileSwitcher.js`: Replace it with `MagicMirror²`.

## [MMM-Profilepicture by Snille](https://github.com/Snille/MMM-Profilepicture)

1. Typo: Found 'Magic Mirror' in file `MMM-Profilepicture.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Property-Managed.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-Property-Managed.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-QRCode.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Quotable.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'node-fetch' in file `README.md`: Replace it with built-in fetch.
3. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-RAIN-RADAR.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-RNV.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
4. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-ROVA-trashcalendar.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-RSS-FEED by Taolanoz](https://github.com/Taolanoz/MMM-RSS-FEED)

1. Recommendation: Found 'XMLHttpRequest' in file `feednami.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `RVVHelper.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-RaiderIO by jwcnewton](https://github.com/jwcnewton/MMM-RaiderIO)

1. Typo: Found 'Magic Mirror' in file `MMM-RaiderIO.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-RaiderIO.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-RainForecast.css`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-RainForecast.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'XMLHttpRequest' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-RandomPhoto.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'require("https")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-RecentRainfall.js`: Replace it with built-in fetch.

## [MMM-Recipe by cowboysdude](https://github.com/cowboysdude/MMM-Recipe)

1. Typo: Found 'Magic Mirror' in file `MMM-Recipe.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Reddit.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
5. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Regenradar.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-RemoteCompliments.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-RepRapFirmware.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-ResRobot.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'node-fetch' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Rest.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Ring by DustinBryant](https://github.com/DustinBryant/MMM-Ring)

1. Typo: Found 'Magic Mirror' in file `MMM-Ring.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-RottenTomatoes.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `RubishCollection.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Ruter.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-Ruter.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-SG-Transport-V2.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-SORT.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Sbanken by reidarw](https://github.com/reidarw/MMM-Sbanken)

1. Typo: Found 'Magic Mirror' in file `MMM-Sbanken.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Screen-Powersave-Notification.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-Scrobbler.js`: Replace it with built-in fetch.

## [MMM-SearchLight by mykle1](https://github.com/mykle1/MMM-SearchLight)

1. Typo: Found 'Magic Mirror' in file `MMM-Searchlight.js`: Replace it with `MagicMirror²`.

## [MMM-SeawayLockTraffic by ProfKP](https://github.com/ProfKP/MMM-SeawayLockTraffic)

1. Typo: Found 'Magic Mirror' in file `MMM-SeawayLockTraffic.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Selfie by Txukie](https://github.com/Txukie/MMM-Selfie)

1. Typo: Found 'Magic Mirror' in file `MMM-Selfie.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-SendNotificationButton.js`: Replace it with `MagicMirror²`.

## [MMM-Seneye by Si-Hill](https://github.com/Si-Hill/MMM-Seneye)

1. Typo: Found 'Magic Mirror' in file `MMM-Seneye.js`: Replace it with `MagicMirror²`.
2. Typo: Found '<sub>2</sub>' in file `MMM-Seneye.js`: Replace it with `²`.`.
3. Recommendation: Found 'XMLHttpRequest' in file `MMM-Seneye.js`: Replace it with built-in fetch.

## [MMM-SensorGateway by mattileh](https://github.com/mattileh/MMM-SensorGateway)

1. Typo: Found 'Magic Mirror' in file `MMM-SensorGateway.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Serial-Notifications by Tom-Hirschberger](https://github.com/Tom-Hirschberger/MMM-Serial-Notifications)

1. Typo: Found 'Magic Mirror' in file `MMM-Serial-Notifications.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `APDS-9960-And-HC-SR04-Example.ino`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `APDS-9960-Example.ino`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `APDS-9960_Multi-VL53L0X.ino`: Replace it with `MagicMirror²`.
5. Typo: Found 'Magic Mirror' in file `APDS-9960_Multi-VL53L1X.ino`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-ShairportMetadata.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `README.org`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-SimpleText.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Skola24.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-Skolmaten by retroflex](https://github.com/retroflex/MMM-Skolmaten)

1. Typo: Found 'Magic Mirror' in file `MMM-Skolmaten.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-Skyss by PabloDons](https://github.com/PabloDons/MMM-Skyss)

1. Typo: Found 'Magic Mirror' in file `MMM-Skyss.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-Skyss.js`: Replace it with built-in fetch.
3. Recommendation: Found 'require("https")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-SlackAnnouncements.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-SlackAnnouncements.js`: Replace it with built-in fetch.

## [MMM-SleeperNFL by jackmeyer](https://github.com/jackmeyer/MMM-SleeperNFL)

1. Typo: Found 'Magic Mirror' in file `MMM-SleeperNFL.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'node-fetch' in file `README.md`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-SmartTouch.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-SmartWebDisplay by AgP42](https://github.com/AgP42/MMM-SmartWebDisplay)

1. Typo: Found 'Magic Mirror' in file `MMM-SmartWebDisplay.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Snow.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Solar.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-SolarEdge by bertieuk](https://github.com/bertieuk/MMM-SolarEdge)

1. Typo: Found 'Magic Mirror' in file `MMM-SolarEdge.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-SolarEdgeLite.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-SolarPicture by grenagit](https://github.com/grenagit/MMM-SolarPicture)

1. Typo: Found 'Magic Mirror' in file `MMM-SolarPicture.js`: Replace it with `MagicMirror²`.

## [MMM-Solarman by utzl](https://github.com/utzl/MMM-Solarman)

1. Typo: Found 'Magic Mirror' in file `MMM-Solarman.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Space.js`: Replace it with `MagicMirror²`.

## [MMM-SpaceLaunchNow by koxm](https://github.com/koxm/MMM-SpaceLaunchNow)

1. Recommendation: Found 'XMLHttpRequest' in file `MMM-SpaceLaunchNow.js`: Replace it with built-in fetch.

## [MMM-SpaceX by koxm](https://github.com/koxm/MMM-SpaceX)

1. Recommendation: Found 'XMLHttpRequest' in file `MMM-SpaceX.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-SpotifyConnectUI.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-SpotifyReleases by Ruud14](https://github.com/Ruud14/MMM-SpotifyReleases)

1. Recommendation: Found 'XMLHttpRequest' in file `SpotifyConnector.js`: Replace it with built-in fetch.
2. Deprecated: Found 'require('request')' in file `app.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-StorH.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-StorH.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-SunRiseSet.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Swipe.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'electron-rebuild' in file `package.json`: Replace it with `@electron/rebuild`
...
1. Typo: Found 'Magic Mirror' in file `MMM-SwissStationboard.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-SwissStationboard.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-SystemMonitor.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'MagicMirror2' in file `MMM-TAF.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-TFL-Status.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'require('https')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-TRV-WastePlan.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-TakeAndDrive.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-TautulliActivity by derekn](https://github.com/derekn/MMM-TautulliActivity)

1. Typo: Found 'MagicMirror2' in file `MMM-TautulliActivity.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Temperature.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Tesla3.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-TextPerWeek.js`: Replace it with `MagicMirror²`.

## [MMM-Thingiverse by appdevelopmentandsuch](https://github.com/appdevelopmentandsuch/MMM-Thingiverse)

1. Typo: Found 'Magic Mirror' in file `MMM-Thingiverse.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-Thingiverse.js`: Replace it with built-in fetch.

## [MMM-TiHimawari8Earth by zhouxichun](https://github.com/zhouxichun/MMM-TiHimawari8Earth)

1. Typo: Found 'Magic Mirror' in file `MMM-TiHimawari8Earth.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-ToDoLive.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `SECURITY.md`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'XMLHttpRequest' in file `maps-web.min.js`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `tomtomv6.html`: Replace it with `MagicMirror²`.

## [MMM-Toon by MichMich](https://github.com/MichMich/MMM-Toon)

1. Typo: Found 'Magic Mirror' in file `MMM-Toon.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'require('https')' in file `ToonAPI.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `trainconnections.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `trainconnections.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-TranslatedMessages.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-TransporteCABA.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Tronity.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Tube-Status by nigel-daniels](https://github.com/nigel-daniels/MMM-Tube-Status)

1. Typo: Found 'Magic Mirror' in file `MMM-Tube-Status.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-TweetsByTimelineOrList.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-TwitchAlert by WilliamFitzjohn](https://github.com/WilliamFitzjohn/MMM-TwitchAlert)

1. Recommendation: Found 'XMLHttpRequest' in file `MMM-TwitchAlert.js`: Replace it with built-in fetch.

## [MMM-TwitterTrendsByPlace by AdamMoses-GitHub](https://github.com/AdamMoses-GitHub/MMM-TwitterTrendsByPlace)

1. Typo: Found 'Magic Mirror' in file `MMM-TwitterTrendsByPlace.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-UKTide.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-Unsplash.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-VUB-Resto.js`: Replace it with `MagicMirror²`.

## [MMM-ValuesByNotification by Tom-Hirschberger](https://github.com/Tom-Hirschberger/MMM-ValuesByNotification)

1. Typo: Found 'Magic Mirror' in file `MMM-ValuesByNotification.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-VartaESS by deg0nz](https://github.com/deg0nz/MMM-VartaESS)

1. Typo: Found 'Magic Mirror' in file `MMM-VartaESS.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `jquery-3.3.1.min.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `MMM-VideoPlayer.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-Videoplayer by Snille](https://github.com/Snille/MMM-Videoplayer)

1. Typo: Found 'Magic Mirror' in file `MMM-Videoplayer.css`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-Videoplayer.js`: Replace it with `MagicMirror²`.

## [MMM-VietNamEventsCalendar by phungorquan](https://github.com/phungorquan/MMM-VietNamEventsCalendar)

1. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `calendarfetcher.js`: Replace it with `MagicMirror²`.

## [MMM-ViewNotifications by glitch452](https://github.com/glitch452/MMM-ViewNotifications)

1. Typo: Found 'Magic Mirror' in file `MMM-ViewNotifications.js`: Replace it with `MagicMirror²`.

## [MMM-VigiCrues by grenagit](https://github.com/grenagit/MMM-VigiCrues)

1. Typo: Found 'Magic Mirror' in file `MMM-VigiCrues.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-VigiCrues.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-vindsiden.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Volume.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-WH2600.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-WWI.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-Wallpaper by jupadin](https://github.com/jupadin/MMM-Wallpaper)

1. Typo: Found 'Magic Mirror' in file `MMM-Wallpaper.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Recommendation: Found 'XMLHttpRequest' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-WeatherAlerts.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Issue: Found directory `node_modules`. This shouldn't be uploaded. Add `node_modules/`to `.gitignore`.
4. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-WeatherChart.js`: Replace it with `MagicMirror²`.

## [MMM-WeatherDependentClothes by fruestueck](https://github.com/fruestueck/MMM-WeatherDependentClothes)

1. Typo: Found 'Magic Mirror' in file `MMM-WeatherDependentClothes.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-WeatherDependentClothes.js`: Replace it with built-in fetch.

## [MMM-WeatherGraph by FlatPepsi17](https://github.com/FlatPepsi17/MMM-WeatherGraph)

1. Recommendation: Found 'XMLHttpRequest' in file `d3.min.js`: Replace it with built-in fetch.

## [MMM-WeatherOrNot by mykle1](https://github.com/mykle1/MMM-WeatherOrNot)

1. Typo: Found 'Magic Mirror' in file `MMM-WeatherOrNot.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-WebView.js`: Replace it with `MagicMirror²`.

## [MMM-WeeklySchedule by pinsdorf](https://github.com/pinsdorf/MMM-WeeklySchedule)

1. Typo: Found 'Magic Mirror' in file `MMM-WeeklySchedule.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-WhisperGPT.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-Widget.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-WorldTides.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-WorldTides.js`: Replace it with built-in fetch.
3. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-Worldclock by BKeyport](https://github.com/BKeyport/MMM-Worldclock/)

1. Typo: Found 'Magic Mirror' in file `MMM-Worldclock.js`: Replace it with `MagicMirror²`.
2. Issue: Found directory `node_modules`. This shouldn't be uploaded. Add `node_modules/`to `.gitignore`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-WunderGround.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-XKCD by jupadin](https://github.com/jupadin/MMM-XKCD)

1. Typo: Found 'Magic Mirror' in file `MMM-XKCD.css`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-XKCD.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-YrNow.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
4. Recommendation: Found 'XMLHttpRequest' in file `readTextFile.js`: Replace it with built-in fetch.
...
1. Issue: Found directory `node_modules`. This shouldn't be uploaded. Add `node_modules/`to `.gitignore`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-aqicn.js`: Replace it with `MagicMirror²`.

## [MMM-aviationwx by stuloh](https://github.com/stuloh/MMM-aviationwx)

1. Typo: Found 'MagicMirror2' in file `MMM-aviationwx.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-chromecast.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'MagicMirror2' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `casting.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-cryptocurrency.js`: Replace it with built-in fetch.
2. Recommendation: Found 'require("https")' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-dht22 by nebulx29](https://github.com/nebulx29/MMM-dht22)

1. Typo: Found 'Magic Mirror' in file `MMM-dht22.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-fbPageCounter.js`: Replace it with built-in fetch.

## [MMM-fitbit by SVendittelli](https://github.com/SVendittelli/MMM-fitbit)

1. Typo: Found 'Magic Mirror' in file `MMM-fitbit.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-germanwordclock.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.

## [MMM-gpsd by brentpabst](https://github.com/brentpabst/MMM-gpsd)

1. Typo: Found 'Magic Mirror' in file `MMM-gpsd.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-iCloud-Client.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-iFrame by alberttwong](https://github.com/alberttwong/MMM-iFrame)

1. Typo: Found 'Magic Mirror' in file `MMM-iFrame.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-iFrame-GSlides by jharttech](https://github.com/jharttech/MMM-iFrame-GSlides)

1. Typo: Found 'Magic Mirror' in file `MMM-iFrame-GSlides.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-iHaveBeenThere.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `ammap.js`: Replace it with built-in fetch.
3. Recommendation: Found 'XMLHttpRequest' in file `ammap_amcharts_extension.js`: Replace it with built-in fetch.
4. Recommendation: Found 'XMLHttpRequest' in file `dataloader.js`: Replace it with built-in fetch.
5. Recommendation: Found 'XMLHttpRequest' in file `dataloader.min.js`: Replace it with built-in fetch.
6. Recommendation: Found 'require('https')' in file `fabric.js`: Replace it with built-in fetch.
7. Recommendation: Found 'XMLHttpRequest' in file `fabric.js`: Replace it with built-in fetch.
8. Recommendation: Found 'require("https")' in file `fabric.min.js`: Replace it with built-in fetch.
9. Recommendation: Found 'XMLHttpRequest' in file `fabric.min.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-ioBroker.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'require('https')' in file `node_helper.js`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-jokes.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-kudos.js`: Replace it with built-in fetch.

## [MMM-learnlanguage by thekampany](https://github.com/thekampany/MMM-learnlanguage)

1. Recommendation: Found 'XMLHttpRequest' in file `MMM-learnlanguage.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-lyft.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `.gitignore`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-max.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-meteoblueCurrent by Bangee44](https://github.com/Bangee44/MMM-meteoblueCurrent)

1. Typo: Found 'Magic Mirror' in file `MMM-meteoblueCurrent.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-meteoblueCurrent.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-nasaastropic.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `Bug_report.md`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `readme.md`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `MMM-pollen.js`: Replace it with built-in fetch.

## [MMM-portscan by Wanztwurst](https://github.com/Wanztwurst/MMM-portscan)

1. Typo: Found 'Magic Mirror' in file `MMM-portscan.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `portscan.css`: Replace it with `MagicMirror²`.

## [MMM-qnapDownloadStation by flick116](https://github.com/flick116/MMM-qnapDownloadStation)

1. Typo: Found 'Magic Mirror' in file `MMM-qnapDownloadStation.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-rain-forecast.js`: Replace it with `MagicMirror²`.
2. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-rbtv-sendeplan by juliankern](https://github.com/juliankern/MMM-rbtv-sendeplan)

1. Typo: Found 'Magic Mirror' in file `MMM-rbtv-sendeplan.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-rbtv-sendeplan.js`: Replace it with built-in fetch.

## [MMM-shabbat by sheyabernstein](https://github.com/sheyabernstein/MMM-shabbat)

1. Typo: Found 'Magic Mirror' in file `MMM-shabbat.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-shabbat.js`: Replace it with built-in fetch.
3. Typo: Found 'MagicMirror2' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `stib.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `stibFetcher.js`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
1. Typo: Found 'Magic Mirror' in file `MMM-stocks.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-swisstransport.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.

## [MMM-synology-ds by Thlb](https://github.com/Thlb/MMM-synology-ds)

1. Typo: Found 'Magic Mirror' in file `MMM-synology-ds.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-syslog by paviro](https://github.com/paviro/MMM-syslog)

1. Typo: Found 'Magic Mirror' in file `MMM-syslog.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-teamspeak3 by Thlb](https://github.com/Thlb/MMM-teamspeak3)

1. Typo: Found 'Magic Mirror' in file `MMM-teamspeak3.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-temp-ds18b20 by Thlb](https://github.com/Thlb/MMM-temp-ds18b20)

1. Typo: Found 'Magic Mirror' in file `MMM-temp-ds18b20.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.

## [MMM-text-clock by ngnijland](https://github.com/ngnijland/MMM-text-clock)

1. Typo: Found 'Magic Mirror' in file `MMM-text-clock.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Found 'XMLHttpRequest' in file `jquery.js`: Replace it with built-in fetch.
2. Typo: Found 'Magic Mirror' in file `mmm-toggle-by-mqtt.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'MagicMirror2' in file `mmm-toggle-by-mqtt.js`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-transitfeed by bnitkin](https://github.com/bnitkin/MMM-transitfeed)

1. Typo: Found 'Magic Mirror' in file `MMM-transitfeed.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-uber by kyle-kelly](https://github.com/kyle-kelly/MMM-uber)

1. Typo: Found 'Magic Mirror' in file `MMM-uber.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Deprecated: Found 'require('request')' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Typo: Found 'Magic Mirror' in file `MMM-weatherforecast.js`: Replace it with `MagicMirror²`.
2. Recommendation: Found 'XMLHttpRequest' in file `MMM-weatherforecast.js`: Replace it with built-in fetch.

## [MMM-wordnik by SVendittelli](https://github.com/SVendittelli/MMM-wordnik)

1. Typo: Found 'Magic Mirror' in file `MMM-wordnik.js`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [MMM-xiaomi by mirko3000](https://github.com/mirko3000/MMM-xiaomi)

1. Typo: Found 'Magic Mirror' in file `.gitignore`: Replace it with `MagicMirror²`.
2. Typo: Found 'Magic Mirror' in file `MMM-xiaomi.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `calendar_monthly.js`: Replace it with `MagicMirror²`.
...
4. Recommendation: Found 'require('https')' in file `alexa-authentication.js`: Replace it with built-in fetch.
5. Recommendation: Found 'require('https')' in file `alexa-companion-service.js`: Replace it with built-in fetch.
6. Typo: Found 'Magic Mirror' in file `pom.xml`: Replace it with `MagicMirror²`.
7. Typo: Found 'Magic Mirror' in file `CompanionServiceAuthenticator.java`: Replace it with `MagicMirror²`.
8. Deprecated: Found 'electron-rebuild' in file `package.json`: Replace it with `@electron/rebuild`
9. Typo: Found 'Magic Mirror' in file `sphinx-model-generator.js`: Replace it with `MagicMirror²`.

## [mm-hide-all by masters1222](https://github.com/masters1222/mm-hide-all)

1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Recommendation: Found 'XMLHttpRequest' in file `jquery.js`: Replace it with built-in fetch.
3. Typo: Found 'Magic Mirror' in file `mm-hide-all.js`: Replace it with `MagicMirror²`.
...
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'XMLHttpRequest' in file `jquery.js`: Replace it with built-in fetch.
4. Typo: Found 'Magic Mirror' in file `mm-music-player.js`: Replace it with `MagicMirror²`.
5. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.

## [mm-tkl-timetable by JurnetFIN](https://github.com/JurnetFIN/mm-tkl-timetable)

1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `mm-tkl-timetable.js`: Replace it with `MagicMirror²`.
3. Deprecated: Found 'require("request")' in file `node_helper.js`: Replace it with built-in fetch.
...
1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `mmm-amazon-photos.js`: Replace it with `MagicMirror²`.
4. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
5. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
...
1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Recommendation: Found 'XMLHttpRequest' in file `mmm-uah-currency.js`: Replace it with built-in fetch.
...
1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `next-train-transilien.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
...
4. Typo: Found 'Magic Mirror' in file `package.json`: Replace it with `MagicMirror²`.
5. Recommendation: Found 'XMLHttpRequest' in file `packed_client.js`: Replace it with built-in fetch.

## [on-this-day by elliefairholm](https://github.com/elliefairholm/on-this-day)

1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `README.md`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `on-this-day.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `random_quotes.js`: Replace it with `MagicMirror²`.
...
1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `node_helper.js`: Replace it with `MagicMirror²`.
3. Typo: Found 'Magic Mirror' in file `voicecontrol.js`: Replace it with `MagicMirror²`.

## [worldclock by ulrichwisser](https://github.com/ulrichwisser/worldclock)

1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `worldclock.js`: Replace it with `MagicMirror²`.

## [wuforecast by MattLugar](https://github.com/MattLugar/wuforecast)

1. Recommendation: Module name doesn't follow the recommended pattern (it doesn't start with `MMM-`). Consider renaming your module.
2. Typo: Found 'Magic Mirror' in file `wuforecast.js`: Replace it with `MagicMirror²`.
3. Recommendation: Found 'XMLHttpRequest' in file `wuforecast.js`: Replace it with built-in fetch.
